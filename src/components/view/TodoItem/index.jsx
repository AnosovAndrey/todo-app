...
const TodoItem = inject("Store")(
    observer(({Store, todo, removeTodo, editTodo}) =>
    {
        ...
        function handleRemove() {
            axios
            .delete("http://localhost:3001/tasks/" + todo.id)
        ...
        return (
            ...
            <Link to={`/user/${todo.user}`}>
                <span className="userName" onClick={() => setUser(todo.user)}>User: {todo.user}</span>
            </Link>
            </li>
        );
    })
